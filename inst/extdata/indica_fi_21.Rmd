...
<br> 
```{r fig.width=6,fig.height=5}
wkDF3 <- tidyr::gather(wkDF2,key= "Country",value="Indicator",
                        colMS)
...
```{r,echo=FALSE,eval=FALSE, fig.width=6,fig.height=5}
semaforo
```
...
```{r,echo=FALSE,fig.width=6,fig.height=altezzIG00}
...
<img src="eurofound.jpg" width=50px height=40px>
<br>
```{r,echo=FALSE,fig.width=6,fig.height=altezzIG0}
# select subset of time
