...
write.csv(df2, "member_states_cluster.csv", row.names = F)
msdf <- read.csv("member_states_cluster.csv")
...
ftab <- footnote(ftab,i = 1, j=1, part = 'header', value = as_paragraph(c("Please refer to member_states_cluster.csv file for the complete dataset")), ref_symbols = "*") %>% width(., width = 1)
...
webshot2::webshot("flx2.html", file="flextab.png")
