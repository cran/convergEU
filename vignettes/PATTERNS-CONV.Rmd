...
vignette: >
  %\VignetteIndexEntry{pattern-conv}
...
```
* a list of the member states labels for which the differences for a given idicator between the target time and the reference time are smaller than zero :
```{r}
