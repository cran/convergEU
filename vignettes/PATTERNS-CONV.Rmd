...
vignette: >
  ...
  % \VignetteDepends{ggplot2,dplyr,eurostat,purrr,tibble,tidyr,formattable,kableExtra,caTools,gridExtra,knitr,magrittr,readr,readxl,utf8}
...
```
* a list of the differences for a given indicator between the target time and the reference time for each member state:
```{r}
